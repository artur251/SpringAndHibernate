...
public class TranslationCopy {
    ...
    public TranslationCopy() {
    }

    public TranslationCopy(int id, String word, String language, String source, String sentence, String translation, int knownLevel, Date timestampInsert, Date timestampUpdate) {
        this.id = id;
        this.word = word;
